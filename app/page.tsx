...
export const metadata: Metadata = {
  title: 'Church Management for Pentecostal Churches| Churza',
  description: 'Giving, attendance, cell groups, sermons, prayer and member management for Pentecostal churches.',
};
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 px-6 min-h-screen flex flex-col items-center justify-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in stagger-3">
          <a href='https://onelink.to/498suf'>
      ...
      <section id="download" className="py-20 px-6">
        <div className="max-w-6xl mx-auto rounded-[3rem] bg-gold-gradient p-12 md:p-20 text-center text-navy">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href='https://onelink.to/498suf'> <button className="bg-navy text-cream px-8 py-4 rounded-xl font-bold hover:bg-navy-elevated transition-colors">App Store</button></a>
            <a href='https://onelink.to/498suf'> <button className="bg-navy text-cream px-8 py-4 rounded-xl font-bold hover:bg-navy-elevated transition-colors">Play Store</button></a>
